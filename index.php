...
<body>
    ...
    <form action="/confim/payment.php" method="post">
        <div div class="head">
            <h2>ชำระเงิน</h2>
            <p>ชำระเงินโดยธนาคารข้างต้น <a href="../img/banking.png">Mobile Banking</a></p>
        </div>
        <div class="form-group">
            ...
            <div class="card s">
                ...
                <li class="list-group-item"><input name="rdoBank" type="radio" value="ไทยพาณิชย์" onClick="JavaScript:frmMain.hdnBank.value='ไทยพาณิชย์ [256-2-01317-7]';">ไทยพาณิชย์ [045-2-35809-1]</br></li>
                <li class="list-group-item"><input name="rdoBank" type="radio" value="กรุงศรีอยุธยา" onClick="JavaScript:frmMain.hdnBank.value='กรุงศรีอยุธยา [131-1-00001-6]';">กรุงศรีอยุธยา [131-1-00001-6] <br></li>
                ...
                <li class="list-group-item"><input name="rdoBank" type="radio" value="ทีเอ็มบีธนาชาต" onClick="JavaScript:frmMain.hdnBank.value='ทีเอ็มบีธนาชาต [238-2-11007-6]';">ทีเอ็มบีธนาชาต [238-2-11007-6]</p></li>
                </ul>
            </div>
            <br>
